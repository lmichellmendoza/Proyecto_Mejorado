...
router.get("/login_trabajosocial", function(req, res) {
    res.render("login_trabajosocial");
});

router.post("/login_trabajosocial", async function(req, res) { // Usamos async aquí
...
router.get("/cuadro_mando_tranajosocial", function(req, res) {
